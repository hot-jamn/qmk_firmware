...
#define PROG_R LT(_PROGRAMMING, KC_RIGHT)
...
[_PROGRAMMING] = LAYOUT_ortho_4x12(
    KC_PERC,  KC_LPRN,   KC_RPRN,  GREATEREQ,  LESSEQ,   DIVEQ,      _______,       TD(PARENS),  KC_NLCK,  KC_PSLS, KC_PAST, KC_PMNS,
    KC_MINS,  KC_LCBR,   KC_RCBR,  OR,        AND,       TIMESEQ,    TD(TRIANGLE),  TD(CURLY),   KC_P7,    KC_P8,   KC_P9,   KC_PPLS,
    KC_UNDS,  SQOPEN,    SQCLS,    PLUSEQ,     MINUSEQ,  DECREMENT,  _______,       TD(SQUARE),  KC_P4,    KC_P5,   KC_P6,   KC_PENT,
    _______,  KC_LT,     KC_GT,    ISEQ,       NOTEQ,    INCREMENT,  INCREMENT,     KC_P0,       KC_P1,    KC_P2,   KC_P3,   KC_PDOT
)
...
void right_prog_finished(qk_tap_dance_state_t *state, void *user_data) {
  ...
  switch (ctrltap_state.state) {
    ...
    case DOUBLE_HOLD: 
      ...
      break;
    case DOUBLE_TAP:
      tap_code(KC_RGHT); register_code(KC_RGHT); 
      break;
    case DOUBLE_SINGLE_TAP: 
      tap_code(KC_RGHT); register_code(KC_RGHT); 
      break;
    case TRIPLE_TAP: 
      tap_code(KC_RGHT);  tap_code(KC_RGHT);  register_code(KC_RGHT);
      break;
  }
}

void right_prog_reset(qk_tap_dance_state_t *state, void *user_data) {
  switch (ctrltap_state.state) {
    case SINGLE_TAP: 
    case SINGLE_HOLD:
    case DOUBLE_SINGLE_TAP:
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [R_PROG] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, right_prog_finished, right_prog_reset),
};